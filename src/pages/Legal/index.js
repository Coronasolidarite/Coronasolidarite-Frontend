...
export default function Legal() {
  return (
    <Container>
      ...
      <p>
        Corona Solidarité <br/>
        Contactez nous : <a href="mailto:coronasolidarité@gmail.com ">coronasolidarité@gmail.com </a><br/>
        Site web hébergé par Github<br/>
        Nom de domain fournit par GoDaddy<br/>
        Base de donnée hébergé par Google<br/>
      </p>
      ...
      <h1>Mention Relative à l’utilisation des cookies</h1>
      <p>
        Le site web Corona Solidarité n’utilise pas de cookie.
      </p>

      <h1>Mention relative à l’utilisation de données personnel</h1> 
 
      <p>
        Les informations recueillies vous concernant font l’objet d’un traitement destiné à : Corona Solidarité <br />
        Pour la finalité suivante : Bon fonctionnement de la plateforme. Nous nous engageons à ne jamais utiliser vos donnée à des fins publicitaire ou commerciales.<br />
